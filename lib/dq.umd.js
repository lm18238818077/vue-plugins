(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["dq"] = factory(require("vue"));
	else
		root["dq"] = factory(root["Vue"]);
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return _ctx.show ? ((0,external_commonjs_vue_commonjs2_vue_root_Vue_.openBlock)(), (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementBlock)("div", _hoisted_1, [(0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementVNode)("div", _hoisted_2, [((0,external_commonjs_vue_commonjs2_vue_root_Vue_.openBlock)(), (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementBlock)(external_commonjs_vue_commonjs2_vue_root_Vue_.Fragment, null, (0,external_commonjs_vue_commonjs2_vue_root_Vue_.renderList)(10, i => {
    return (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementVNode)("p", {
      key: i,
      onClick: $event => _ctx.handleClick(i - 1)
    }, (0,external_commonjs_vue_commonjs2_vue_root_Vue_.toDisplayString)(i - 1), 9, _hoisted_3);
...
/* harmony default export */ var Toastvue_type_script_lang_js = ((0,external_commonjs_vue_commonjs2_vue_root_Vue_.defineComponent)({
  props: {
    show: {
      type: Boolean
    }
...
var exportHelper = __webpack_require__(430);
...
const props = (0,external_commonjs_vue_commonjs2_vue_root_Vue_.reactive)({
  show: false
});
/** 空函数 */
...
/* harmony default export */ var components_Toast = ({
  install: (app, options) => {
    if (!$vm) {
      ...
      $vm = (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createApp)({
        setup() {
          return () => {
            // setup 可以返回一个render函数
            // h函数接收3个参数，“组件或dom”、props、children
            return (0,external_commonjs_vue_commonjs2_vue_root_Vue_.h)(Toast, { // 其他属性，会被当做组件的props <Keyboard :show="props.show" />
              ...props,
...
//# sourceMappingURL=dq.umd.js.map